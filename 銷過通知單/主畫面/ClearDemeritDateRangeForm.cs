...
{
    public partial class ClearDemeritDateRangeForm : SelectDateRangeForm
    {
        ...
        string ConfigName = "銷過通知單_ForK12.2013";
        ...
        public MemoryStream Template
        {
            get
            {
                ...
                {
                    return  _defaultTemplate = new MemoryStream(Properties.Resources.銷過通知單_住址上方版);
                }
                else //預設範本1 
                {
                    return  _defaultTemplate = new MemoryStream(Properties.Resources.銷過通知單_住址中間版);
                }
            }
        }
        ...
        public ClearDemeritDateRangeForm()
        {
            InitializeComponent();
            Text = "銷過通知單";
            LoadPreference();
        ...
        private void LoadPreference()
        {
            ...
            {
                #region 產生空白設定檔
                config = new XmlDocument().CreateElement("銷過通知單");
                ...
                cd.SetXml("XmlData", config);
                //CurrentUser.Instance.Preference["銷過通知單"] = config;
        ...
        {
            //傳入True是因為不影響程式結構
            ClearDemeritConfigForm configForm = new ClearDemeritConfigForm(
                _useDefaultTemplate, _mode, _buffer, _receiveName, _receiveAddress, _PrintStudentList);
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            sfd.Title = "另存新檔";
            sfd.FileName = "銷過通知單_功能變數總表.docx";
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    fs.Write(Properties.Resources.銷過通知單_功能變數總表, 0, Properties.Resources.銷過通知單_功能變數總表.Length);
                    fs.Close();
